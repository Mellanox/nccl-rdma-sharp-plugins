...
ncclResult_t ncclSharpIallreduce(void* collComm, void* sendData, void* recvData, size_t count,
...
ncclResult_t ncclSharpIallreduce_v8(void* collComm, void* sendData, void* recvData, int count,
      ncclDataType_t dataType, ncclRedOp_t redOp, void* sendMhandle, void* recvMhandle, void** request) {
  return ncclSharpIallreduce(collComm, sendData, recvData, (size_t)count, dataType, redOp, sendMhandle,
		  recvMhandle, request);
}
                                 ...
                                 void* recvMhandle, void** request)
{
 ...
 ncclResult_t ncclSharpIreducescatter_v8(void* collComm, int nSendParts, ncclNetSGE_v8_t* sendParts, void* recvData,
                                 size_t bytesPerRank, size_t windowOffset, size_t windowBytes,
                                 ncclDataType_t dataType, ncclRedOp_t redOp,
                                 void* recvMhandle, void** request) {
...
ncclCollNet_v8_t ncclCollNetPlugin_v8 = {
  ...
  ncclSharpIallgather_v8,
  ncclSharpIreducescatter_v8,
  ncclSharpIflush,
  ncclSharpTest,
  ncclSharpCloseColl,
  ncclSharpCloseListen
