...
static ncclResult_t nccl_uct_wr_isend_v9(void* sendComm, void* data, size_t size, int tag, void* mhandle, void** request) {
  return nccl_uct_wr_isend(sendComm, data, size, tag, mhandle, NULL, request);
}

static ncclResult_t nccl_uct_wr_irecv_v9(void* recvComm, int n, void** data, size_t* sizes, int* tags, void** mhandles, void** request) {
  return nccl_uct_wr_irecv(recvComm, n, data, sizes, tags, mhandles, NULL, request);
}

static ncclResult_t nccl_uct_wr_isend_v8(void *send_comm, void *data, int size,
                                      int tag, void *mhandle, void **request) {
  return nccl_uct_wr_isend_v9(send_comm, data, (size_t)size, tag, mhandle, request);
}
